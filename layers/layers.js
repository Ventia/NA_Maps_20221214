...
lyr_Navaids_20221209_1.set('fieldImages', {'OID': 'Hidden', 'Asset_Number': 'Range', 'Location_Code': 'TextEdit', 'Location': 'TextEdit', 'NavAid_Name': 'TextEdit', 'NavAid_Primary_Function': 'Hidden', 'Status': 'TextEdit', 'Northing': 'TextEdit', 'Easting': 'TextEdit', 'UTM_Zone': 'Range', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Chart_Character': 'TextEdit', 'Flash_Sequence': 'TextEdit', 'Light_Range': 'TextEdit', 'Light_Colour': 'TextEdit', 'Light_Model': 'TextEdit', 'Lead_Bearing': 'TextEdit', 'Daymark': 'TextEdit', 'Mark_Structure': 'Hidden', 'Situation': 'TextEdit', 'Risk_Category': 'Range', 'Infrastructure_Subgroup_Code': 'Hidden', 'Function_Code': 'Hidden', 'Horizontal_Accuracy': 'Hidden', 'Responsible_Agency': 'Hidden', 'Owner': 'Hidden', 'NavAid_Shape': 'TextEdit', 'NavAid_Colour': 'TextEdit', 'AIS_Type': 'Hidden', 'MMSI_Number': 'Hidden', });
lyr_Navaids_20221209_1.set('fieldLabels', {'Asset_Number': 'inline label', 'Location_Code': 'inline label', 'Location': 'inline label', 'NavAid_Name': 'inline label', 'Status': 'inline label', 'Northing': 'inline label', 'Easting': 'inline label', 'UTM_Zone': 'inline label', 'Latitude': 'inline label', 'Longitude': 'inline label', 'Chart_Character': 'inline label', 'Flash_Sequence': 'inline label', 'Light_Range': 'inline label', 'Light_Colour': 'inline label', 'Light_Model': 'inline label', 'Lead_Bearing': 'inline label', 'Daymark': 'inline label', 'Situation': 'inline label', 'Risk_Category': 'inline label', 'NavAid_Shape': 'inline label', 'NavAid_Colour': 'inline label', });
